    ...
    return (
        <div className="header">
            <div className={type === 'list' ? 'headerContainer listMode' : 'headerContainer'}>
                ...
                {type !== 'list' && (
                    <>
                        <h1 className="headerTitle">Diskon seumur hidup?.</h1>
                        <p className="headerDesc">Dapatkan imbalan untuk perjalanan Anda – buka penghematan instan sebesar 10% atau lebih dengan akun VIVIBOOKING gratis</p>
                        {!user && <button className="headerBtn">Sign in / Register</button>}
                        <div className="headerSearch">
                            <div className="headerSearchItem">
                                <FontAwesomeIcon icon={faBed} className="headerIcon" />
                                <input type="text" placeholder="Kemana anda pergi?" className="headerSearchInput" onChange={(e) => setDestination(e.target.value)} />
                            </div>
                            <div className="headerSearchItem">
                            ...
                            <div className="headerSearchItem">
                                ...
                                <span onClick={() => setOpenOptions(!openOptions)} className="headerSearchText">{`${options.adult} Dewasa · ${options.children} Anak-anak · ${options.room} room`}</span>
                                {openOptions && (
